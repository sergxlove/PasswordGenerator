...
using PasswordGenerator.Models.Enums;
using System;
    ...
    public partial class MainWindow : Window
    {
        ...
        public void GeneratePasswordButtonHandler(object sender, RoutedEventArgs e)
        {
            ...
            aviableChars.AddRange(SelectRandomSymbols(length - quantitySpecific - quantityValues,
                (bool)UppercaseCheck.IsChecked!, (bool)LowercaseCheck.IsChecked!));
            ...
            var levelPassword = GetLevelComplexity(result);
        ...
        private int GetQuantitySpecificSymbols(int length)
        {
            switch (length)
            {
        ...
        private int GetQuantityValuesSymbols(int length)
        {
            switch (length)
            {
                case int l when l >= 5 && l <= 10:
        ...
        private List<char> SelectRandomValueSymbols(int count)
        {
        ...
        private List<char> SelectRandomSpecificSymbols(int count)
        {
            List<char> result = new List<char>();
            Random rnd = new Random();
        ...
        private List<char> SelectRandomSymbols(int count, bool isLow, bool isStrong)
        {
        ...
        private LevelComplexity GetLevelComplexity(string password)
        {
